...
const SEGMENTS = [
  {
    ...
    detail:
      "Ship a feature, fix a bug, close a customer — Orbit turns it into a post the same day, drafted and queued for a 10-second approval.",
  },
  {
    tag: "Indie hackers",
    line: "Turn building updates into daily distribution.",
    detail:
      "You're already doing the work. Orbit watches for what's worth sharing and keeps your build-in-public feed alive without it becoming a second job.",
  },
  {
    tag: "Agencies",
  ...
  },
  {
    ...
    detail:
      "Feed Orbit your voice and your rules once. It drafts in that voice every day — you're still the one who hits approve.",
  },
];
...
const STEPS = [
  {
    ...
    detail:
      "Orbit researches trends and conversations relevant to your product — not generic filler, tuned to what you actually do.",
  },
  {
    number: "02",
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900">
      ...
      <main>
          ...
          <div className="grid items-center gap-14 md:grid-cols-2">
            <div>
              ...
              <h1 className="mt-4 text-4xl font-semibold leading-tight tracking-tight md:text-5xl">
                Your marketing team, waiting on your approval.
              </h1>
              <p className="mt-5 max-w-md text-lg text-neutral-600">
                Orbit researches what's worth posting, drafts it in your voice for X, Threads, and
                LinkedIn, and queues it up. You approve or reject. It handles the rest.
              </p>
        ...
        <section className="border-t border-neutral-200 bg-neutral-50">
          <div className="mx-auto max-w-6xl px-6 py-20">
            <h2 className="text-2xl font-semibold tracking-tight md:text-3xl">What Orbit actually does</h2>
            <p className="mt-3 max-w-2xl text-neutral-600">
              Not a scheduler. Not a generic AI writer. Orbit is the loop from "what's worth saying" to
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3 rounded-lg border border-neutral-200 p-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-600">Flagged for a human to handle — Orbit won't touch it.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-6xl px-6 py-20">
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-2">
              {SEGMENTS.map((segment) => (
                <div key={segment.tag} className="rounded-xl border border-neutral-200 bg-white p-6">
      ...
      <footer className="border-t border-neutral-200 py-8">
        <p className="mx-auto max-w-6xl px-6 text-sm text-neutral-500">© Orbit</p>
      </footer>
    </div>
  );
}
